...
Выводов всего: 46
Из них со ссылкой на конкретный пункт: 46 (100%)
```

Разбивка выводов: 24 дублирования, 13 функций, ставших общими, 4 передачи между подразделениями, 2 созданных подразделения, 2 сохранённых, 1 подозрение на потерю. Полный разбор двух документов по 300+ пунктов занимает около 45 секунд.
