...
Текущий результат на контрольном комплекте (режим embeddings): **4 подразделения после (2 создано), 5 возможных потерь функций, 10 передач между подразделениями, 24 дублирования**.
